...
family_feuds = Category.create(name: "Family Feuds")
product_strategies = Category.create(name: "Product Strategies")
letters_from_larry = Category.create(name: "Letters From Larry")
noteworthy_notes = Category.create(name: "Noteworthy Notes")
...
from_our_partners = Category.create(name: "From Our Partners")
