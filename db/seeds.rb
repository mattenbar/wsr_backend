...
Ad.create({
    :title => "Berkshire",
    :company => "Berkshire",
    :image =>  "http://res.cloudinary.com/wealthsolutionsreport/image/upload/v1617657968/t7jpe11yd84qj89klqec.png",
    :link => "http://berkshireglobal.com/"
})

Ad.create({
    :title => "Advisor Group",
    :company => "Advisor Group",
    :image =>  "http://res.cloudinary.com/wealthsolutionsreport/image/upload/v1617658012/pglon3szsolwv0l0c7o9.png",
    :link => "http://info.advisorgroup.com/surprise-and-delight-guide?utm_source=wealth-solutions-report&utm_medium=display&utm_campaign=2021_Recruiting_AG_Publication-Lead-Gen&utm_term=661x269&utm_content=mycmo-support"
})
...
Statshot.create({
    :content => '<h2 style="text-align: center;">Healthcare Costs for Independent Financial Advisors &ndash; 5 Most Expensive and Least Expensive States</h2>
        <h3 style="text-align: center;"><em>While growth opportunities are significant for independent financial advisors, one of the single largest overhead items for any independent advisor continues to be healthcare for the professional, his or her family members and full-time staff, if any.</em><br /><br /><em>Thinking of going independent? Bear in mind that the state you live in will determine how costly securing your own healthcare insurance could be.</em></h3>
        <p><em>TOP 5 MOST EXPENSIVE STATES FOR ADVISORS:</em></p>
        <ol>
        ...
        <p>TOP 5 LEAST EXPENSIVE STATES FOR ADVISORS:</p>
        <ol>
        <li>Hawaii</li>
        <li>Alabama</li>
        <li>Michigan</li>
        ...
        <p>*We get it. &ldquo;Northern California&rdquo; isn&rsquo;t a state.</p>
    ...
    :image => "http://res.cloudinary.com/wealthsolutionsreport/image/upload/v1620373145/ninhalzb5asfo57e38ow.jpg",
})